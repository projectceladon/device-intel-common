...
DDR_CONV_SCRIPT				:= device/intel/common/boot/sofia-asus/conv_ddr_params.sh
CREATE_INJECTION_SCRIPT_SCRIPT		:= device/intel/common/boot/sofia-asus/create_ddr_injection_script.sh
