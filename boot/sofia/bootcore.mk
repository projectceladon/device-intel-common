...
bootcore.$(1): $$(BUILT_LIBSOC_TARGET.$(1)) libssl_static2 libcrypto_static2
	...
	$$(MAKE) -C $$(SOFIA_FW_SRC_BASE)/bootsystems/make PLATFORM=$$(MODEM_PLATFORM) PROJECTNAME=$$(MODEM_PROJECTNAME_VAR) VARIANT=$(1) BL_OUTPUT_DIR=$$(abspath $$(SOFIA_FIRMWARE_OUT.$(1))) SOC_LIB=$$(abspath $$(BUILT_LIBSOC_TARGET.$(1)))  all
endif
