...
SOFIA_PROVDATA_FILES.$(1) += $$(PSI_RAM_SIGNED_FLS.$(1)) $$(EBL_SIGNED_FLS.$(1))  $$(PSI_FLASH_SIGNED_FLS.$(1)) $$(SLB_SIGNED_FLS.$(1))  $$(SYSTEM_SIGNED_FLS_LIST.$(1)) $$(ANDROID_SIGNED_FLS_LIST.$(1)) $$(SYSTEM_FLS_SIGN_SCRIPT)
