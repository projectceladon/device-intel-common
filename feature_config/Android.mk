...
INTEL_SUPPORTED_FEATURES := \
        INTEL_FEATURE_PARALLEL_SCAN \
        INTEL_FEATURE_AWARESERVICE \
        INTEL_FEATURE_ADAPTIVE_AUTHENTICATION \
        INTEL_FEATURE_CTA_SUPPORT \
        INTEL_FEATURE_PARALLEL_PRELOAD \
        INTEL_FEATURE_VIDEO_EXT_MODE \
        INTEL_FEATURE_UX_ENHANCEMENT \
        INTEL_FEATURE_UNITY_REPLACEMENT \
        INTEL_FEATURE_PRC_COMPATIBILITY \
        INTEL_FEATURE_COMPATIBILITY_ENHANCEMENT
