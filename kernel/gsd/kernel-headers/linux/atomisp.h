...
enum atomisp_acc_memory {
  ATOMISP_ACC_MEMORY_PMEM0 = 0, ATOMISP_ACC_MEMORY_DMEM0, ATOMISP_ACC_MEMORY_VMEM0, ATOMISP_ACC_MEMORY_VAMEM0, ATOMISP_ACC_MEMORY_VAMEM1, ATOMISP_ACC_MEMORY_VAMEM2, ATOMISP_ACC_MEMORY_HMEM0, ATOMISP_ACC_NR_MEMORY
};
#else
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
enum atomisp_acc_memory {
