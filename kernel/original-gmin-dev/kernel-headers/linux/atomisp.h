...
#define V4L2_CID_LENS_APETURE	(V4L2_CID_CAMERA_LASTP1 + 37)
#define V4L2_CID_LENS_FILTER_DENSITY	(V4L2_CID_CAMERA_LASTP1 + 38)
#define V4L2_CID_LENS_FOCAL_LENGTH	(V4L2_CID_CAMERA_LASTP1 + 39)
#define V4L2_CID_LENS_OPTICAL_STABILIZATION_MODE (V4L2_CID_CAMERA_LASTP1 + 40)
