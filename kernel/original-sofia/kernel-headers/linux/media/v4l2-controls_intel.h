...
#define INTEL_VIDIOC_SUBDEV_S_STATE \
_IOW('v', BASE_VIDIOC_PRIVATE+1, enum intel_subdev_state)

#define INTEL_VIDIOC_SUBDEV_G_MIPI_CSI_CFG \
_IOR('v', BASE_VIDIOC_PRIVATE+2, struct intel_v4l2_subdev_mipi_csi_config)

#define INTEL_VIDIOC_QBUF \
_IOW('v', BASE_VIDIOC_PRIVATE+3, struct intel_v4l2_buffer)
