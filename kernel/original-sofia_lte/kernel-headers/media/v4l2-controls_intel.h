...
/*
request private data stored in sensor internal memory.
 */
...
#define INTEL_VIDIOC_G_SENSOR_OTP \
_IOWR('v', BASE_VIDIOC_PRIVATE+1, struct isp_supplemental_sensor_otp_data)
