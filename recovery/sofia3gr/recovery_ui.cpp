...
class Sofia3gUI : public ScreenRecoveryUI {
  public:
    Sofia3gUI() :
...
class Sofia3gDevice : public Device {
  public:
    Sofia3gDevice() : Device(new Sofia3gUI) {
    }
